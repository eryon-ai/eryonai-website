...
import { Brain, Globe, Smartphone, Cloud, ShieldCheck, Palette, Zap } from 'lucide-react';
      ...
      <div className="container-custom relative z-10" ref={ref}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 md:gap-6">
          {capabilities.map((cap, i) => (
            ...
            >
              <GlowCard color={cap.color} className="p-6 md:p-7" style={{ background: cap.gradient }}>
                {/* Icon */}
                <div
                  className="w-11 h-11 rounded-xl flex items-center justify-center mb-5"
                  style={{ background: `${cap.color}18`, border: `1px solid ${cap.color}30` }}
                >
                  <cap.icon size={22} strokeWidth={2} color={cap.color} aria-hidden="true" />
                </div>
